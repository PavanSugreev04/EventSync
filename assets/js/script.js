...
var apiKey = "&apikey=dOXPVuzOgpuOVGypSXvxuZfBwBrQAviG";
var pageSize = "&size=5";
            ...
            if (brewRL) {
                fetch(brewRL, {
                    ...
                    .then(function (brew) {
                        ...
                        var mapURL = "https://maps.googleapis.com/maps/api/staticmap?size=600x400&markers=color:blue|label:B|" + latLonJoined + "&key=" + AIzaSyD4Sfnb51e-phzxl3d16ZK4fBbFtUDdJJQ;
